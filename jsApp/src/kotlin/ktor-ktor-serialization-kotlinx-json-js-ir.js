(function (_, kotlin_io_ktor_ktor_serialization_kotlinx, kotlin_io_ktor_ktor_http, kotlin_kotlin, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_json) {
  ...
  function json$default(_this__u8e3s4, json_0, contentType, $mask0, $handler) {
    ...
    if (!(($mask0 & 2) === 0))
      contentType = Application_getInstance().p2f_1;
  ...
  function DefaultJson$lambda() {
    return function ($this$Json) {
      ...
      $this$Json.h10_1 = true;
      $this$Json.b10_1 = true;
      $this$Json.c10_1 = false;
      $this$Json.f10_1 = false;
  ...
  //endregion
  return _;
}(module.exports, require('./ktor-ktor-serialization-kotlinx-js-ir.js'), require('./ktor-ktor-http-js-ir.js'), require('./kotlin-kotlin-stdlib-js-ir.js'), require('./kotlinx-serialization-kotlinx-serialization-json-js-ir.js')));
